...
{
    py::dict d(
        py::arg("longitude")     = _observatory["longitude"],
...
py::tuple SPA_Analyzer::calc_sun_position_at(
    ...
    int hour, int minute, int second)
{
    ...
    if (result == 0)
    {
        ...
        {
        case 1:
            err_msg = "Year Not in valid range: -2000 to 6000, " + std::to_string(year);
            break;
        case 2:
            err_msg = "Month Not in valid range: 1 to 12, " + std::to_string(month);
            break;
        case 3:
            err_msg = "Day Not in valid range: 1 to 31, " + std::to_string(day);
            break;
        case 4:
            err_msg = "Hour Not in valid range: 0 to 24, " + std::to_string(hour);
            break;
        case 5:
            err_msg = "Minute Not in valid range: 0 to 59, " + std::to_string(minute);
            break;
        case 6:
            err_msg = "Second Not in valid range: 0 to <60, " + std::to_string(second);
            break;
        case 7:
            err_msg = "Delta_t Not in valid range: -8000 to 8000 seconds, " + std::to_string(_observatory["delta_t"]);
            break;
        case 8:
            err_msg = "Timezone Not in valid range: -18 to 18 hours, " + std::to_string(_observatory["timezone"]);
            break;
        case 9:
            err_msg = "Longitude Not in valid range: -180 to 180 degrees, " + std::to_string(_observatory["longitude"]);
            break;
        case 10:
            err_msg = "Latitude Not in valid range: -90 to 90 degrees, " + std::to_string(_observatory["latitude"]);
            break;
        case 11:
            err_msg = "Elevation Not in valid range: -6500000 or higher meters, " + std::to_string(_observatory["elevation"]);
            break;
        case 12:
            err_msg = "Pressure Not in valid range: 0 to 5000 millibars, " + std::to_string(_observatory["pressure"]);
            break;
        case 13:
            err_msg = "Temperature Not in valid range: -273 to 6000 degrees Celsius, " + std::to_string(_observatory["temperature"]);
            break;
        case 14:
        ...
        case 15:
            ...
            break;
        case 16:
            err_msg = "Atmos_Refract Not in valid range: -5 to 5 degrees, " + std::to_string(_observatory["atmos_refract"]);
            break;
        case 17:
            err_msg = "Delta_ut1 Not in valid range: -1 to 1 second (exclusive), " + std::to_string(_observatory["delta_ut1"]);
            break;
        default:
